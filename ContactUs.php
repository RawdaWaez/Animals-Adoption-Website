...
<head>
    ...
    <title>Adopte Me Contact US </title>
  ...
  ?>
    <div class="content">
        <aside>
            <nav>
                <ul>
                    ...
                    <li><a class="maincolor active" href="ContactUs.php">&#128222; Contact Us </a></li>
        ...
        <main class="paragraph">
            <h2>Contact Us</h2>
            <p>Name: Rawda Waez</p>
            <p>Student ID: 40139173</p>
            <p>Email: <a href="mailto:rawdawaez@gmail.com">rawdawaez@gmail.com</a></p>
